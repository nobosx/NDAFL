...
def make_resnet(num_words=4, num_filters=32, num_outputs=1, d1=64, d2=64, word_size=24, ks=3, depth=5, reg_param=0.0001, final_activation='sigmoid'):
...
def train_speck_distinguisher(num_epochs=10, num_rounds=7, depth=1, diff=(0x80, 0x0), folder='./', master_key_bit_length=72):
    #create the network
...
def train_speck_distinguisher_with_former_net(num_epochs=10, num_rounds=7, depth=1, diff=(0x80, 0x0), folder='./', master_key_bit_length=72):
    #create the network
...
def train_speck_distinguisher_only_diff(num_epochs=10, num_rounds=7, depth=1, diff=(0x80, 0x0), folder='./', master_key_bit_length=72):
    #create the network
...
def train_speck_distinguisher_only_diff_with_former_net(num_epochs=10, num_rounds=7, depth=1, diff=(0x80, 0x0), folder='./', master_key_bit_length=72):
    #create the network
