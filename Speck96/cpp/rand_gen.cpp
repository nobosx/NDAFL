...
uint16_t RandomGenerator::rand_16bits() {
	uint16_t res = rand_byte();
	res = (res << 8) | rand_byte();
	return res;
}

uint32_t RandomGenerator::rand_32bits() {
	uint32_t res = rand_16bits();
	res = (res << 16) | rand_16bits();
	return res;
}

uint64_t RandomGenerator::rand_64bits() {
	uint64_t res = rand_32bits();
	res = (res << 32) | rand_32bits();
	return res;
}
